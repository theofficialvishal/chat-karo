...
export const updateProfile = async (req, res) => {
  try {
    ...
    // in auth.middleware we added req.user = user that why we can access user in req
    const userId = req.user._id; //it will undefine if we did not pass it in middleware
